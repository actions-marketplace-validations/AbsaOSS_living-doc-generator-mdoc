...
- Mocking rules
  - Must mock environment variables (INPUT_*) in unit tests when behavior depends on them.
  - Must isolate filesystem I/O behind tmp_path/fixtures; avoid writing outside temp dirs.
  - Must not call real network services in unit tests.
